...
public class Homework2 {
    ...
    public static void main(String[] args) {
        ...
        moveArray(new int[]{1, 2, 3}, 1);
        moveArray(new int[]{1, 2, 3}, 7);
        moveArray(new int[]{3, 5, 6, 1}, -2);
        moveArray(new int[]{3, 5, 6, 1}, -10);
        System.out.println("");
    }
    ...
    * */
    public static void fillArrayByStepThree() {
        int[] array = new int[8];
        int value = 0;
        for (int i = 0; i < 8; i ++) {
            array[i] = value;
    ...
    * */
    public static void expandByTwo() {
